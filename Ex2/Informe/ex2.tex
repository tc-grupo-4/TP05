...
\begin{figure}[ht]
\begin{center}
\input{../Ex2/Informe/plantilla.tex}
\end{center}
...
\begin{figure}[ht]
\begin{center}
\includegraphics[height=7.5cm]{../Ex2/Informe/TransferenciaTotal.png}
...
\begin{figure}[ht]
\begin{center}
\includegraphics[height=7.5cm]{../Ex2/Informe/TransferenciaCell1.png}
...
\begin{figure}[ht]
\begin{center}
\includegraphics[height=7.5cm]{../Ex2/Informe/TransferenciaCell2.png}
...
\begin{figure}[ht]
\begin{center}
\includegraphics[height=7.5cm]{../Ex2/Informe/ImpedanciaTotal.png}
...
Considerando una tensión mínima de salida $V_{oMin} = 10 \si{\mili\volt}$ y que la ganancia mínima de este circuito según la plantilla debe ser de
