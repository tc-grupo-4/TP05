...
\begin{figure}[ht]
\begin{center}
\includegraphics[height=7.5cm]{TransferenciaTotal.png}
...
\begin{figure}[ht]
\begin{center}
\includegraphics[height=7.5cm]{TransferenciaCell1.png}
...
\begin{figure}[ht]
\begin{center}
\includegraphics[height=7.5cm]{TransferenciaCell2.png}
...
\begin{figure}[ht]
\begin{center}
\includegraphics[height=7.5cm]{ImpedanciaTotal.png}
...
\begin{figure}[ht]
\begin{center}
\includegraphics[height=7.5cm]{ImpedanciaCell1.png}
...
\begin{figure}[ht]
\begin{center}
\includegraphics[height=7.5cm]{ImpedanciaCell2.png}
...
Considerando una tensión mínima de salida $V_{o min} = 10 \si{\mili\volt}$ y que la ganancia mínima de este circuito según la plantilla debe ser de $-3 \si{\deci\bel} \approx 0.708 V/V$:
