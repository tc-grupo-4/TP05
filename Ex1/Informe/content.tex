...
\begin{figure}[H]
	\centering
	\includegraphics[scale=0.5,keepaspectratio]{../Ex1/Informe/BodeBessel.png}
	\caption{Medición del filtro con aproximación de Bessel}
	\label{fig:medicionbessel}
\end{figure}
	Como se prosiguió con la implementacion de este filtro sin darse cuenta del error comentado anteriormente, lo medido corresponde a una frecuencia de $2.7 \, kHz$.
	Se sabe que este circuito no cumple con las especificaciones dadas por la cátedra en la consigna, por lo que volverá a implementarse esta vez de forma correcta para una nueva entrega y se adjuntara también las mediciones del filtro con aproximación de Legendre que no lograron a realizarse a tiempo.